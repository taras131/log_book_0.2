...
import {deleteOrder, sendOrder} from "../../../../redux/order/orderReducer";
...
export const OrderItem = (props) => {
    ...
    const orderItemBlocks = props.arr_data.map((item, index) => <OrderItemBlock key={item.id} {...item} index={index}/>)
    ...
    const onSendClick = () => {
        dispatch(sendOrder(emailList[0], emailList[1], emailList[2], title, car.brand, car.model, car.yearManufacture,
            car.num, car.vin, props.arr_data))
    }
    return (
